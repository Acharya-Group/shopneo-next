  ...
  return (
    <section className="relative overflow-hidden">
      <div className="container mx-auto py-12 px-4">
        ...
        <div className="flex justify-center items-center gap-4 sm:gap-10 pt-6 max-w-2xl mx-auto">
          {topLogos.map((logo, index) => (
            <motion.div
              ...
              data-aos="flip-left"
              className="bg-[#f5a30a7a] hover:bg-[#f5a30a8a] transition-colors duration-300 rounded-lg w-full h-20 sm:h-32 flex p-4 items-center justify-center"
            >
              <Image
                src={logo.img}
                alt={logo.alt}
        ...
        {/* Bottom Row */}
        <div className="flex justify-center gap-4 sm:gap-10 pt-6 max-w-2xl mx-auto">
          {bottomLogos.map((logo, index) => (
            <motion.div
             ...
             transition={{ type: "tween", ease: "linear", duration: 0.1 }}
              data-aos="flip-left"
              className="bg-[#f5a30a7a] hover:bg-[#f5a30a8a] transition-colors duration-300 rounded-lg w-full h-20 sm:h-32 flex items-center justify-center p-4"
            >
              <Image
                src={logo.img}
                alt={logo.alt}
