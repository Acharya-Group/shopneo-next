...
export default function Footer() {
  ...
  const pages = ["About Us", "Careers", "Contact Us", "Media", "FAQ", "Privacy Policy"];
  const explore = ["Blogs", "Help Topics", "Sell on Mystore", "Product Sorting Criteria", "Seller Training Manual"];
  const collections = ["Amazing India", "Direct from Farmers", "Fashion on ONDC", "Home Decor on ONDC", "Summer Collection"];
  const ondcNetwork = [
    "About ONDC Network",
