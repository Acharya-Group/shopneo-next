    ...
    <section className="relative overflow-hidden bg_golden">
      <div className="container mx-auto py-12 px-4">
        <div className="text-center mb-8">
          <h2 data-aos-duraction="1000" data-aos="fade-up" className="text-2xl font-semibold">Minimal Commissions</h2>
          <p data-aos-duraction="2000" data-aos="fade-up" className="text-gray-700">
